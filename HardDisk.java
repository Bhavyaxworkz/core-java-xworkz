class HardDisk{
  ...
  public static void main(String disk[]){
     ...
     String brandName = "Western";
     int price = 4449;
     String storage = "1.5 tera bytes";
	 String hardDiskInterface = "USB 1.1";
	 String hardDiskFormFactor = "2.5 inches";
	 String compatibility = "USB 3.0 and 2.0";
