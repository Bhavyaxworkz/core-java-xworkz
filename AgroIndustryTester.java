...
public static void main(String agroIndustry[]){
	  ...
	  agroIndustry1.quantityProducedInKg = 400;
	  ...
	  agroIndustry2.quantityProducedInKg = 330;
	  ...
	  agroIndustry4.quantityProducedInKg = 215;
	  ...
	  agroIndustry5.quantityProducedInKg = 345;
	  ...
	  agroIndustry6.quantityProducedInKg = 270;
	  ...
	  agroIndustry7.quantityProducedInKg = 199;
	  ...
	  agroIndustry8.quantityProducedInKg = 155;
	  ...
	  agroIndustry9.quantityProducedInKg = 500;
	  ...
	  agroIndustry10.quantityProducedInKg = 304;
