...
public static void main(String suite[]){
 ...
 suitCase6.weight = "8kg";
 suitCase6.price = 6000;
 suitCase6.noOfCompartments = 7;
 ...
 suitCase7.price = 8900;
 suitCase7.noOfCompartments = 7;
