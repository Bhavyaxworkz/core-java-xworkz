class MusicalInstrumentsTester{
  ...
  public static void main(String args[]){
   ...
   instrument1.color = "Blue color";
   instrument1.price = 5600;
   ...
   instrument8.color = "Pink";
   instrument8.price = 2000;
